...
function exercise1(num1) {
  ...
  function exercise2(num2) {
    ...
    // --------------------------------------------
    // couldn't remember how to determine if a number was even so looked that up
    if (num2 % 2 === 0) {
    ...
    // And above here
    // --------------------------------------------
    // had it wrong and figured out why it kept showing up as undefined
    return answer2;
  }
  ...
  // Maybe if varA was 5 and varB was "five" - technically they are both 5 but they are not 
  // equal in value due to five not being written as a number. I wonder if true or false, 
  // if written (true, "true") would be considered equal. 
  // I went to refresh my memory of other data types, and now I wonder if arrays and objects
  // put in as arguments that are exactly the same would pass.
  ...
  function exercise7(num7) {
    ...
    // And above here
    // --------------------------------------------
    // I definitely forgot how switches were formatted, so I
    // skipped this and then came back and looked it up using freeCodeCamp
    return answer7;
  }
  ...
  function exercise8(amount1, amount2, minimum, maximum) {
    ...
    // And above here
    // --------------------------------------------
    // I'm thinking there must be a more efficient way to do this, but it worked
    return answer8;
  }
  ...
  // I skipped this one at first, because I had no recollection of how to find the data type
  // googled 'check data type javascript' and was reminded of "typeof"
...
console.log(exercise10(15))
  ...
  // I'm using VSCode to code these, and it doesn't give me a console - for sone reason my outpout isn't working, 
  // so I would take my code over to codesandbox so I could see the resuls immediately
