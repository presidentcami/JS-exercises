...
const dreamDestination = "Singapore";
...
// num2 but not num1?
// num1's value can be basically any number between 2 and 9, but can't be 1 because it must
// be greater than 1 nor 10 because it must be less than 10. num2's value could be 1 or 10,
// or anything in between, due to the assignments being greater than or equal to, and less 
// than or equal to.
...
const myAnswerForExercise12 = "undefined or null";
...
const myAnswerForExercise16 = "undefined I think - can't multiply a letter with a number";
...
// I wouldn't say this was hard, though it did sort of tickle my brain. I didn't use any 
// references at first, but upon writing this comment, I did want to check and verify
// what the || means, because I questioned myself. checked w3schools and turns out I was right!
// I also wasn't very positive about exercises 12 and 16 so (for 16) I did some testing to check, but didn't change my answer.
